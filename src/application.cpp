...
{
    auto vertShaderCode = readFile("shaders/particles_vert.spv");
    auto fragShaderCode = readFile("shaders/particles_frag.spv");
...
{
    auto computeShaderCode = readFile("shaders/particles_comp.spv");
